...
public class BtnEvent_BigShot : ResumeButton
{
    ...
    public void UpgradeSelected() 
    {
        if (upgradeLvl != maxLvl)
        {
            ...
            PlayerStatus.instance.damage += 5;
            PlayerStatus.instance.atkSpeedMutiplier = 4;
            PlayerStatus.instance.projectileScale += 5;
